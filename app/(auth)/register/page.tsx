/**
 * Register Page: Authentication page for user sign-up.
 *
 * This page provides:
 ...
 *
 * @returns Register page with Clerk SignUp component
 */
import { SignUp } from "@clerk/nextjs";

/**
 * Register page component that renders the Clerk SignUp interface.
 *
 * Layout:
 ...
 *
 * @returns Register page with themed Clerk SignUp component
 */
export default function RegisterPage() {
  return (
    <main className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      {/* Clerk SignUp Component - Custom styled authentication interface */}
      <SignUp
        routing="hash"
        appearance={{
          elements: {
