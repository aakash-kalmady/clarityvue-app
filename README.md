...
- **👤 Secure User Authentication:** A complete and secure authentication system with social sign-on options (Google) and robust profile management, powered by **Clerk**.
